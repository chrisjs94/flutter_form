...
class SliverAppBarMapForm extends StatelessWidget {
  final dynamic onSaveButtonClick; final dynamic onMapButtonClick;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: currentLocation == null ? circularProgress('La aplicación está intentando obtener las coordenadas más actuales y precisas de su dispositivo, espere un momento por favor...') : CustomScrollView(
        slivers: [
          SliverAppBar(
